    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Create Producer</li>
            </ul>
        </div>
    </div>
    <section>
        <div class="container-fluid">
            <header>
                <h1 class="h3 display">Create Producer </h1>
            </header>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{action('ProducerController@store')}}" class="form-horizontal"
                                  role="form">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="maker_code"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="shop_id" class="form-control">
                                                ...
                                                @foreach( $shop as $key => $value)
                                                    <option value="{{$key + 1}}">{{$value->shop_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
