    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Copy Product</li>
            </ul>
        </div>
    </div>
    <section>
        <div class="container-fluid">
            <header>
                <h1 class="h3 display">Copy Product</h1>
            </header>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_code"
                                                   ...
                                                   value="{{old('product_code',isset($product) ? $product->product_code : null)}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="notax_price" type="text" name="notax_price"
                                                   class="form-control {{ $errors->has('notax_price') ? 'is-invalid' : '' }}"
                                                   value="{{old('notax_price',isset($product) ? $product->notax_price : null)}}">
                                            <span class="invalid-feedback">{{ $errors->first('notax_price') }}</span>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Tax inclusive price</label>
                                            <input id="tax_price" type="text" name="tax_price" class="form-control"
                                                   value="{{old('tax_price',isset($product) ? $product->tax_price : null)}}">
                                        </div>
                                        <div class="form-group required">
                                            ...
                                            <input id="member_price" type="text" name="member_price"
                                                   ...
                                                   value="{{old('member_price',isset($product) ? $product->member_price : null)}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <select name="shop_id"
                                                ...
                                                @foreach( $store as $item)
                                                    <option
                                                            @if($product->shop_id == $item->id)
                                                            {{"selected"}}
                                                            @endif
                                                            value="{{$item->id}}">{{$item->shop_name}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="maker_id"
                                                ...
                                                @foreach( $maker as $item)
                                                    <option
                                                            ...
                                                            {{"selected"}}
                                                            @endif
                                                            value="{{$item->id}}">{{$item->maker_name}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="supplier_id"
                                                ...
                                                @foreach( $supplier as $item)
                                                    <option
                                                            ...
                                                            {{"selected"}}
                                                            @endif
                                                            value="{{$item->id}}">{{$item->supplier_name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="notes"
                                                   class="form-control"
                                                   value="{{old('notes',isset($product) ? $product->notes : null)}}">
                                        </div>
                                    </div>
                                </div>
                                <hr>
