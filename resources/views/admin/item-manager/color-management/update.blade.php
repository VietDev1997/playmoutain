...
@section('content')
    ...
    <section>
        <div class="container-fluid">
            <header>
                <h1 class="h3 display">Color Update</h1>
            </header>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{action('ColorController@update',$color->id)}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="color_name" class="form-control"
                                                   value="{!! old('color_name',isset($color)? $color->color_name : null) !!}">
                                            <span class="invalid-feedback">{{ $errors->first('color_name') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rgb" class="form-control"
                                                   value="{!! old('rgb', isset($color) ? $color->rgb : null) !!}">
                                            <span class="invalid-feedback">{{ $errors->first('rgb') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <hr>
