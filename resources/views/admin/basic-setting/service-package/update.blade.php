...
@section('content')
    ...
    <section>
        <div class="container-fluid">
            <header>
                <h1 class="h3 display">Edit Service</h1>
            </header>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{action('ListServiceController@update',$value->id)}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="service_name"
                                                   ...
                                                   value="{{old('service_name',$value->service_name)}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="customer_type_id" id="mst_customer_type_id"
                                                    ...
                                                    @foreach($style as $item)
                                                        <option
                                                                @if($value->customer_type_id == $item->id)
                                                                {{"selected"}}
                                                                @endif
                                                                value="{{$item->id}}">{{$item->customer_type}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="service_description" class="form-control"
                                                       value="{{old('service_description',$value->service_description)}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
