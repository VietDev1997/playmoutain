    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Rental Listing</li>
            </ul>
        </div>
    </div>
    <section>
        <div class="container-fluid">
            <header>
                <h1 class="h3 display">Update Rental Listing</h1>
            </header>
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>Update Rental Service</h4>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form method="post" action="{{action('RentalController@update',$list->id)}}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group required">
                                            ...
                                            <input type="text" name="retal_name"
                                                   ...
                                                   value="{{old('retal_name',$list->retal_name)}}">
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <select name="shop_id" id="shop_id"
                                                    class="form- {{ $errors->has('shop_id') ? 'is-invalid' : '' }}">
                                                <option value="">======Select City======</option>
                                                @foreach($store as $op)
                                                    <option
                                                            @if ($list->shop_id == $op->id)
                                                            {{"selected"}}
                                                            @endif
                                                            value="{{$op->id}}">{{$op->shop_name}}</option>
                                                @endforeach
                                            </select>
